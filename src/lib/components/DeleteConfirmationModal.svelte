		...
		>
			<div class="modal-container">
				...
				<div class="modal-footer">
					<button type="button" class="btn-cancel" on:click={handleCancel} disabled={isDeleting}>
						Cancel
					</button>

					<button type="button" class="btn-delete" on:click={handleConfirm} disabled={isDeleting}>
						{#if isDeleting}
