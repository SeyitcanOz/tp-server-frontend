...
<style>
  /* Overlay with full-screen blur - preserved as requested */
  .overlay {
    position: fixed;
    top: 0;
    left: 0;
  ...
  /* Loading & Error Styles - preserved */
  ...
  /* Updated Form Header - styled more like modal header */
  .form-header {
  ...
  /* Radio button styles for modellingType */
  .radio-group {
    display: flex;
    gap: 1.5rem;
    margin-top: 0.5rem;
